...
import { getApiV1WorkOrderReturnWoByWorkOrderNumber } from "@/api/generated/sdk.gen";
import { buildTableColumns } from "@/utils/tableUtils";
import { WorkOrderReturnDrawer } from "./WorkOrderReturnDrawer";
    ...
    <div className="flex flex-col">
      <div className="flex justify-between items-center mb-4 py-2 px-3" style={{ backgroundColor: "var(--ant-color-fill-alter)", borderRadius: "6px" }}>
        <div style={{ color: "var(--ant-color-text-secondary)" }}>
          此製令累計已建立 <span>{list.length}</span> 張退料單
        </div>
