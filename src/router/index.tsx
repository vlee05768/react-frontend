...
export const router = createBrowserRouter([
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'basic/storages/:viewId?', element: <StorageList /> },
      ...
      { path: 'basic/brand-models', element: <BrandModelsLayout /> },
      { path: 'basic/materials/:viewId?', element: <MaterialList /> },
      { path: 'basic/molds/:viewId?', element: <MoldList /> },
      { path: 'basic/machines/:viewId?', element: <MachineList /> },
      ...
      { path: 'sales/pricing', element: <ProductPricingList /> },
